    ...
    <div className="flex flex-col md:flex-row">
      <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <button className="border rounded-lg p-3 bg-slate-700 text-white uppercase hover:bg-white hover:text-slate-700 hover:outline">
            Search
          </button>
        </form>
      </div>
      <div className="flex-1">
        <h1 className="text-3xl sm:text-4xl font-semibold border-b p-3 text-slate-700 mt-5">
          Listing results:
        </h1>
        <div className="p-7 flex flex-wrap gap-4">
          {!loading && listings.length === 0 && (
            <p className="text-xl text-slate-700">No hay resultados!</p>
          )}
          {loading && (
          ...
          {showMore && (
            ...
            className="text-green-700 p-3 hover:bg-green-700 hover:text-white"
            >Show more</button>
          )}
        </div>
      </div>
